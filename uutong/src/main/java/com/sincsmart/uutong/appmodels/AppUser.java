...
public class AppUser implements Serializable{
	...
	public AppUser(UserInfo userInfo) {
		setId(userInfo.getStr("id"));
		setName(userInfo.getStr("name"));
		setGender(userInfo.getInt("gender"));
		setIdentity(userInfo.getStr("identity"));
		setNickName(userInfo.getStr("nickName"));
		setPhone1(userInfo.getStr("phone1"));
		setPortrait(userInfo.getStr("portrait"));
//		appUser.setRegisterTime(userInfo.getTimestamp("registerTime"));
	}
	public String getId() {
		return id;
	}
